*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZCAWF_VM_OMSRLVL
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZCAWF_VM_OMSRLVL    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZCAWF_VM_OMSRLVL'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZCAWF_VM_OMSRLVL_EXTRACT
TOTAL = ZCAWF_VM_OMSRLVL_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZCAWF_VM_OMSRLVL'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZCAWF_VM_OMSRLVL-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZCAWF_VM_OMSRLVL_EXTRACT
TOTAL = ZCAWF_VM_OMSRLVL_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZCAWF_VM_OMSRLVL-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZCAWF_VM_OMSRLVL'
...
TOTAL = ZCAWF_VM_OMSRLVL_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZCAWF_VM_OMSRLVL-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZCAWF_VM_OMSRLVL-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZCAWF_VM_OMSRLVL'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZCAWF_VM_OMSRLVL-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZCAWF_VM_OMSRLVL_EXTRACT
TOTAL = ZCAWF_VM_OMSRLVL_TOTAL

"! <p class="shorttext synchronized" lang="en">CA-WF: OM Search rule exception</p>
CLASS zcx_ca_wf_om_search_rule DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    CONSTANTS:
      BEGIN OF no_valid_jobs_or_tasks_found,
      ...
      END OF no_valid_jobs_or_tasks_found.

    "! <p class="shorttext synchronized" lang="en">My own name</p>
    CONSTANTS c_zcx_ca_wf_om_search_rule TYPE seoclsname VALUE 'ZCX_CA_WF_OM_SEARCH_RULE' ##NO_TEXT.
...
CLASS zcx_ca_wf_om_search_rule IMPLEMENTATION.

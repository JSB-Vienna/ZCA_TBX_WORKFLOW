*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZCAWF_VM_SROVJOB
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZCAWF_VM_SROVJOB    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZCAWF_VM_SROVJOB'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZCAWF_VM_SROVJOB_EXTRACT
TOTAL = ZCAWF_VM_SROVJOB_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZCAWF_VM_SROVJOB'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZCAWF_VM_SROVJOB-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZCAWF_VM_SROVJOB_EXTRACT
TOTAL = ZCAWF_VM_SROVJOB_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZCAWF_VM_SROVJOB-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZCAWF_VM_SROVJOB'
...
TOTAL = ZCAWF_VM_SROVJOB_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZCAWF_VM_SROVJOB-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZCAWF_VM_SROVJOB-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZCAWF_VM_SROVJOB'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZCAWF_VM_SROVJOB-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZCAWF_VM_SROVJOB_EXTRACT
TOTAL = ZCAWF_VM_SROVJOB_TOTAL

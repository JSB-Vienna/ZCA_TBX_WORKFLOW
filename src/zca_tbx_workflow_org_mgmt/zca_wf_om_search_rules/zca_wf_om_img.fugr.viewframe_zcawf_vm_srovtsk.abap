*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZCAWF_VM_SROVTSK
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZCAWF_VM_SROVTSK    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZCAWF_VM_SROVTSK'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZCAWF_VM_SROVTSK_EXTRACT
TOTAL = ZCAWF_VM_SROVTSK_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZCAWF_VM_SROVTSK'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZCAWF_VM_SROVTSK-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZCAWF_VM_SROVTSK_EXTRACT
TOTAL = ZCAWF_VM_SROVTSK_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZCAWF_VM_SROVTSK-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZCAWF_VM_SROVTSK'
...
TOTAL = ZCAWF_VM_SROVTSK_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZCAWF_VM_SROVTSK-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZCAWF_VM_SROVTSK-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZCAWF_VM_SROVTSK'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZCAWF_VM_SROVTSK-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZCAWF_VM_SROVTSK_EXTRACT
TOTAL = ZCAWF_VM_SROVTSK_TOTAL

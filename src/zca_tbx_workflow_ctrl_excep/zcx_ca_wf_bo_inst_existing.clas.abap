"! <p class="shorttext synchronized" lang="en">CA-TBX Workflow exception: Instance already exists</p>
class ZCX_CA_WF_BO_INST_EXISTING definition
  public
  inheriting from ZCX_CA_WF_BO_CREATE_ERROR
  create public .

public section.

  constants:
    begin of ZCX_CA_WF_BO_INST_EXISTING,
    ...
    end of ZCX_CA_WF_BO_INST_EXISTING .
  constants C_ZCX_CA_WF_BO_INST_EXISTING type SEOCLSNAME value 'ZCX_CA_WF_BO_INST_EXISTING' ##NO_TEXT.
...
CLASS ZCX_CA_WF_BO_INST_EXISTING IMPLEMENTATION.
...
if textid is initial.
  IF_T100_MESSAGE~T100KEY = ZCX_CA_WF_BO_INST_EXISTING .
else.

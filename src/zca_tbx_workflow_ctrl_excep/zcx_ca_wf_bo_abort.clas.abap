"! <p class="shorttext synchronized" lang="en">CA-TBX Workflow exception: Abort that requires rollback</p>
class ZCX_CA_WF_BO_ABORT definition
  public
  inheriting from CX_BO_ABORT
  create public .
...
public section.
  ...
  constants C_ZCX_CA_WF_BO_ABORT type SEOCLSNAME value 'ZCX_CA_WF_BO_ABORT' ##NO_TEXT.
  ...
  class-methods CREATE_EXCEPTION
    importing
      !IV_EXCP_CLS type SEOCLSNAME default C_ZCX_CA_WF_BO_ABORT
    ...
    returning
      value(RX_EXCEP) type ref to ZCX_CA_WF_BO_ABORT .
...
CLASS ZCX_CA_WF_BO_ABORT IMPLEMENTATION.

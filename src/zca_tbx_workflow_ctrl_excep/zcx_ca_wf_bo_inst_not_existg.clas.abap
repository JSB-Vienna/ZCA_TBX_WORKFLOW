"! <p class="shorttext synchronized" lang="en">CA-TBX Workflow exception: Instance does not exist</p>
class ZCX_CA_WF_BO_INST_NOT_EXISTG definition
  public
  inheriting from ZCX_CA_WF_BO_DELETE_ERROR
  create public .

public section.

  constants:
    begin of ZCX_CA_WF_BO_INST_NOT_EXISTG,
    ...
    end of ZCX_CA_WF_BO_INST_NOT_EXISTG .
  constants C_ZCX_CA_WF_BO_INST_NOT_EXISTG type SEOCLSNAME value 'ZCX_CA_WF_BO_INST_NOT_EXISTG' ##NO_TEXT.
...
CLASS ZCX_CA_WF_BO_INST_NOT_EXISTG IMPLEMENTATION.
...
if textid is initial.
  IF_T100_MESSAGE~T100KEY = ZCX_CA_WF_BO_INST_NOT_EXISTG .
else.

"! <p class="shorttext synchronized" lang="en">CA-TBX Workflow exception: While searching for an instance</p>
class ZCX_CA_WF_BO_SEARCH_ERROR definition
  public
...
public section.
  ...
  constants:
    begin of ZCX_CA_WF_BO_SEARCH_ERROR,
    ...
    end of ZCX_CA_WF_BO_SEARCH_ERROR .
  constants C_ZCX_CA_WF_BO_SEARCH_ERROR type SEOCLSNAME value 'ZCX_CA_WF_BO_SEARCH_ERROR' ##NO_TEXT.
...
CLASS ZCX_CA_WF_BO_SEARCH_ERROR IMPLEMENTATION.
...
if textid is initial.
  IF_T100_MESSAGE~T100KEY = ZCX_CA_WF_BO_SEARCH_ERROR .
else.

"! <p class="shorttext synchronized" lang="en">CA-TBX Workflow exception: Instance not found</p>
class ZCX_CA_WF_BO_INST_NOT_FOUND definition
  public
  inheriting from ZCX_CA_WF_BO_SEARCH_ERROR
  create public .

public section.

  constants:
    begin of ZCX_CA_WF_BO_INST_NOT_FOUND,
    ...
    end of ZCX_CA_WF_BO_INST_NOT_FOUND .
  constants C_ZCX_CA_WF_BO_INST_NOT_FOUND type SEOCLSNAME value 'ZCX_CA_WF_BO_INST_NOT_FOUND' ##NO_TEXT.
...
CLASS ZCX_CA_WF_BO_INST_NOT_FOUND IMPLEMENTATION.
...
if textid is initial.
  IF_T100_MESSAGE~T100KEY = ZCX_CA_WF_BO_INST_NOT_FOUND .
else.

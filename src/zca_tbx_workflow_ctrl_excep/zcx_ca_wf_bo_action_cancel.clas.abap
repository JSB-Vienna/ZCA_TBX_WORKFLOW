"! <p class="shorttext synchronized" lang="en">CA-TBX Workflow exception: Action cancelled by user</p>
class ZCX_CA_WF_BO_ACTION_CANCEL definition
  public
  inheriting from ZCX_CA_WF_BO_TEMPORARY
  create public .

public section.

  constants:
    begin of ZCX_CA_WF_BO_ACTION_CANCEL,
    ...
    end of ZCX_CA_WF_BO_ACTION_CANCEL .
  constants C_ZCX_CA_WF_BO_ACTION_CANCEL type SEOCLSNAME value 'ZCX_CA_WF_BO_ACTION_CANCEL' ##NO_TEXT.
...
CLASS ZCX_CA_WF_BO_ACTION_CANCEL IMPLEMENTATION.
...
if textid is initial.
  IF_T100_MESSAGE~T100KEY = ZCX_CA_WF_BO_ACTION_CANCEL .
else.

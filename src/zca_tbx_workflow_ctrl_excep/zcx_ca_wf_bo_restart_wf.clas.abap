"! <p class="shorttext synchronized" lang="en">CA-TBX Workflow exception: Restarting workflow</p>
class ZCX_CA_WF_BO_RESTART_WF definition
  public
...
public section.
  ...
  constants:
    begin of ZCX_CA_WF_BO_RESTART_WF,
    ...
    end of ZCX_CA_WF_BO_RESTART_WF .
  constants C_ZCX_CA_WF_BO_RESTART_WF type SEOCLSNAME value 'ZCX_CA_WF_BO_RESTART_WF' ##NO_TEXT.
...
CLASS ZCX_CA_WF_BO_RESTART_WF IMPLEMENTATION.
...
if textid is initial.
  IF_T100_MESSAGE~T100KEY = ZCX_CA_WF_BO_RESTART_WF .
else.
